...
ggplot(data=cluster_means_byboscc_plot,
  ...
  geom_text(aes(cluster_labels, Inf, 
                label = paste0("n = ",cluster_size)), vjust = 1)+
...
ggplot(data=df_all_clust_plot, mapping=aes(x=age, y=boscc_score,
  ...
  xlab("Age (months)")+
  ylab("Raw score")+
  labs(title="Observed BOSCC score trajectories over time,\ncolored by identified cluster.",
       color="Cluster (RRB; SC)")+ 
  scale_color_manual(values=c("#00BA38", "#619CFF", "#F8766D",
                              "#00BA38", "#619CFF", "#F8766D"))+
  theme(text = element_text(size=20))
ggsave("plots_tables/separate_clust_boscc_by_age.jpg",
       scale=2.5, limitsize = FALSE)
